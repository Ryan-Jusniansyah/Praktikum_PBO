...
public class Admin extends akun {
    ...
    public void Db_Nike() throws NumberFormatException, IOException{
        boolean lanjut = true;
        while(lanjut){
            clear();
            System.out.println("\t|==================================|");
    ...
    public void Db_NB() throws NumberFormatException, IOException{
        boolean lanjut = true;
        while(lanjut){
            clear();
            System.out.println("\t|==================================|");
    ...
    public void Db_Adidas() throws NumberFormatException, IOException{
        boolean lanjut = true;
        while(lanjut){
            clear();
            System.out.println("\t|==================================|");
