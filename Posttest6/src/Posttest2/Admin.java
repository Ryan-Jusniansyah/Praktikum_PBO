...
public class Admin extends akun implements Adminint{
    ...
    public void nambah_dataN() throws NumberFormatException, IOException{
        System.out.println("|======================================================|");
    ...
    public void nambah_dataNB() throws NumberFormatException, IOException{
        System.out.println("|======================================================|");
    ...
    public void nambah_dataA() throws NumberFormatException, IOException{
        System.out.println("|======================================================|");
    ...
    public void update_dataN()throws NumberFormatException, IOException{
        if(Nike.isEmpty()){
            clear();
    ...
    public void update_dataNB()throws NumberFormatException, IOException{
        if(NB.isEmpty()){
            clear();
            System.out.println("Data Belum Ada, Tekan Enter untuk melanjutkan");
            input.readLine();
    ...
    public void update_dataA()throws NumberFormatException, IOException{
        if(Adidas.isEmpty()){
            clear();
            System.out.println("Data Belum Ada, Tekan Enter untuk melanjutkan");
            input.readLine();
    ...
    public void delete_dataN() throws NumberFormatException, IOException{
        if(Nike.isEmpty()){
            clear();
            System.out.println("Data Belum Ada, Tekan Enter untuk melanjutkan");
            input.readLine();
    ...
    public void delete_dataNB() throws NumberFormatException, IOException{
        if(NB.isEmpty()){
            clear();
            System.out.println("Data Belum Ada, Tekan Enter untuk melanjutkan");
            input.readLine();
    ...
    public void delete_dataA() throws NumberFormatException, IOException{
        if(NB.isEmpty()){
            clear();
            System.out.println("Data Belum Ada, Tekan Enter untuk melanjutkan");
            input.readLine();
    ...
    public final void Db_Nike() throws NumberFormatException, IOException{
        boolean lanjut = true;
        while(lanjut){
            clear();
            System.out.println("\t|==================================|");
    ...
    public final void Db_NB() throws NumberFormatException, IOException{
        boolean lanjut = true;
        while(lanjut){
            clear();
            System.out.println("\t|==================================|");
    ...
    public final void Db_Adidas() throws NumberFormatException, IOException{
        boolean lanjut = true;
        while(lanjut){
            clear();
            System.out.println("\t|==================================|");
